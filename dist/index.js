...
var vite_config_default = defineConfig({
  ...
  resolve: {
    alias: [
      { find: "@", replacement: path2.resolve(__dirname, "client/src") },
      { find: "@shared", replacement: path2.resolve(__dirname, "shared") },
      {
        find: "@assets",
        replacement: path2.resolve(__dirname, "attached_assets")
      }
    ]
  },
  ...
  server: {
    fs: {
      strict: false
      // Changed to false for Windows compatibility
    }
  }
});
